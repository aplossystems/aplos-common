 ...
 */
public final class AqlParserCopy extends AqlBaseParser {
	/**
	 * A logger for this class.
	 */
	private static final Logger log = LoggerFactory.getLogger( AqlParserCopy.class );
...
//	}
	...
	public static AqlParserCopy getInstance(String hql) {
        // [jsd] The fix for HHH-558...
        AqlBaseLexer lexer = new AqlBaseLexer( new StringReader( hql ) );
		return new AqlParserCopy( lexer );
	}

	private AqlParserCopy(TokenStream lexer) {
		super( lexer );
		initialize();
	}
		...
		switch ( t ) {
			...
			default:
                ...
                if (LA(0) == FROM && t != IDENT && LA(2) == DOT) {
                    AqlToken hqlToken = (AqlToken)LT(1);
...
//		throw new Exception("Parser: panic");
	}
}

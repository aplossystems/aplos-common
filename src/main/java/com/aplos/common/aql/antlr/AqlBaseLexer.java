...
public class AqlBaseLexer extends antlr.CharScanner implements AqlTokenTypes, TokenStream
 {

	// NOTE: The real implementations are in the subclass.
	protected void setPossibleID(boolean possibleID) {}
public AqlBaseLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public AqlBaseLexer(Reader in) {
	this(new CharBuffer(in));
}
public AqlBaseLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public AqlBaseLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("now", this), new Integer(128));
	literals.put(new ANTLRHashString("upper", this), AqlTokenTypes.UPPER);
	literals.put(new ANTLRHashString("lower", this), AqlTokenTypes.LOWER);
	literals.put(new ANTLRHashString("date_format", this), AqlTokenTypes.DATE_FORMAT);
	literals.put(new ANTLRHashString("acos", this), AqlTokenTypes.ACOS);
	literals.put(new ANTLRHashString("sin", this), AqlTokenTypes.SIN);
	literals.put(new ANTLRHashString("radians", this), AqlTokenTypes.RADIANS);
	literals.put(new ANTLRHashString("cos", this), AqlTokenTypes.COS);
	literals.put(new ANTLRHashString("concat", this), AqlTokenTypes.CONCAT);
	literals.put(new ANTLRHashString("coalesce", this), AqlTokenTypes.COALESCE);
	literals.put(new ANTLRHashString("date_add", this), AqlTokenTypes.DATE_ADD);
	literals.put(new ANTLRHashString("interval", this), AqlTokenTypes.INTERVAL);
	literals.put(new ANTLRHashString("datediff", this), AqlTokenTypes.DATEDIFF);
	literals.put(new ANTLRHashString("substring", this), AqlTokenTypes.SUBSTRING);
	literals.put(new ANTLRHashString("year", this), AqlTokenTypes.YEAR);
	literals.put(new ANTLRHashString("month", this), AqlTokenTypes.MONTH);
	literals.put(new ANTLRHashString("day", this), AqlTokenTypes.DAY);
}

...
public class FacesMessagesUtils
{
    ...
    public static int saveMessages(final FacesContext facesContext, final Map<String, Object> destination)
    {
        int restoredCount = 0;
    ...
    @SuppressWarnings("unchecked")
    public static int restoreMessages(final FacesContext facesContext, final Map<String, Object> source)
    {
        int restoredCount = 0;
        if (FacesContext.getCurrentInstance() != null)
        {

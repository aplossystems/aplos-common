...
public class Twitter {
	private String twitter_consumer_key = "uc0tmyLBOOYyKlwaHSagBpj3q";
	private String twitter_consumer_secret = "VvriRZo7Pf8vcggTnfMDg4gifnReItVjcLB2ADlPIDN1V5Hgzk";
